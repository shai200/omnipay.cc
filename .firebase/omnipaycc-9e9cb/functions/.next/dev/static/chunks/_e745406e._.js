...
const getFirebaseConfig = ()=>{
    ...
    const config = ("TURBOPACK compile-time value", '{"apiKey":"AIzaSyB4YMGM8BRrT-goRI7Y2FhzHgHD9JQRtNI","appId":"1:548261736586:web:ee720a197790f900f07d73","authDomain":"omnipaycc-9e9cb.firebaseapp.com","databaseURL":"","messagingSenderId":"548261736586","projectId":"omnipaycc-9e9cb","storageBucket":"omnipaycc-9e9cb.firebasestorage.app"}');
...
const initFirebase = ()=>{
    if (!app) {
        app = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeApp"])(getFirebaseConfig());
...
const getFirebaseServices = ()=>initFirebase();
...
const ensureInitialized = ()=>{
    if (!auth || !db) {
        const { auth: authService, db: dbService } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFirebaseServices"])();
        auth = authService;
        db = dbService;
    }
    return {
...
function AuthProvider({ children }) {
    ...
    const fetchProfile = async (uid)=>{
        try {
            ...
            const ref = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(dbService, 'users', uid);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onAuthStateChanged"])(authService, {
    ...
    const signUp = async (email, password, profileData)=>{
        try {
            ...
            const credential = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createUserWithEmailAndPassword"])(authService, email, password);
    ...
    const signIn = async (email, password)=>{
        const { auth: authService } = ensureInitialized();
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithEmailAndPassword"])(authService, email, password);
    };
    const signInWithGoogle = async ()=>{
        try {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithPopup"])(authService, provider);
            const user = result.user;
            // Check if user profile exists, if not create one
            const userDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(dbService, 'users', user.uid);
    ...
    const signOutUser = async ()=>{
        const { auth: authService } = ensureInitialized();
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signOut"])(authService);
    };
    const updateProfile = async (profileData)=>{
        if (!user) return;
        const { db: dbService } = ensureInitialized();
        const cleaned = cleanProfile(profileData);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(dbService, 'users', user.uid), {
            ...cleaned,
            updatedAt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["serverTimestamp"])()
        }, {
            merge: true
...
_s(AuthProvider, "TWoa2nxz0b/k0yniCZ3VTFXSATM=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
"[project]/app/contexts/ClientProviders.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ClientProviders({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$contexts$2f$ThemeContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ThemeProvider"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthProvider"], {
            ...
            fileName: "[project]/app/contexts/ClientProviders.tsx",
            lineNumber: 10,
            columnNumber: 7
        }, this)
    }, void 0, false, {
...
//# sourceMappingURL=_e745406e._.js.map