...
const scarletRunnerBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Dragon Tongue bean field",
    detail:
      "A climbing scarlet-bloom belt of Scarlet Runner beans on the gravel edge past the Dragon Tongues — long pods catch the same late light the purple streak finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods lengthen and dew still holds. Mara ties ripe stems before the stand opens — the Scarlet Runner bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Scarlet Runner weeks",
    rhythm: "Late autumn board",
    detail:
      "A few fresh snap baskets and dry jars for the farm table after the pack shed has done its quiet work — Leah chalks whole Scarlet Runner when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const rattlesnakeBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Scarlet Runner bean field",
    detail:
      "A purple-streaked pole belt of Rattlesnake beans on the gravel edge past the Scarlet Runners — mottled pods catch the same late light the scarlet bloom finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show purple mottling and dew still holds. Mara ties ripe stems before the stand opens — the Rattlesnake bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Rattlesnake weeks",
    rhythm: "Late autumn board",
    detail:
      "A few fresh snap baskets and dry jars for the farm table after the pack shed has done its quiet work — Leah chalks whole Rattlesnake when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const paintedPonyBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Rattlesnake bean field",
    detail:
      "A cream-and-maroon piebald belt of Painted Pony beans on the gravel edge past the Rattlesnakes — spotted pods catch the same late light the purple mottling finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show cream-and-maroon spots and dew still holds. Mara ties ripe stems before the stand opens — the Painted Pony bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Painted Pony weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and chili sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Painted Pony when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const soldierBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Painted Pony bean field",
    detail:
      "A white-and-scarlet soldier-blotch belt of Soldier beans on the gravel edge past the Painted Ponies — marked pods catch the same late light the cream-maroon spots finish on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the scarlet soldier blotch and dew still holds. Mara ties ripe stems before the stand opens — the Soldier bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Soldier weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and baked-bean sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Soldier when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const tongueOfFireBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Soldier bean field",
    detail:
      "A crimson-streaked cream belt of Tongue of Fire beans on the gravel edge past the Soldiers — flame-marked pods catch the same late light the scarlet soldier blotch finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show crimson fire streaks and dew still holds. Mara ties ripe stems before the stand opens — the Tongue of Fire bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Tongue of Fire weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and stew sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Tongue of Fire when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;
...
const hidatsaShieldFigureBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Good Mother Stallard bean field",
    detail:
      "A cream-and-maroon shield belt of Hidatsa Shield Figure beans on the gravel edge past the Good Mothers — painted shield marks catch the same late light the wine-cream mottling finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the cream shield figure and dew still holds. Mara ties ripe stems before the stand opens — the Hidatsa Shield Figure bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Hidatsa Shield Figure weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and stew sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Hidatsa Shield Figure when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;
...
const fourCornersGoldBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Cherokee Trail of Tears bean field",
    detail:
      "A warm-gold belt of Four Corners Gold beans on the gravel edge past the Cherokees — desert-gold seed catches the same late light the glossy black finish on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the warm gold seed and dew still holds. Mara ties ripe stems before the stand opens — the Four Corners Gold bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Four Corners Gold weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and stew sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Four Corners Gold when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const rioZapeBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Four Corners Gold bean field",
    detail:
      "A purple-brown mottled belt of Rio Zape beans on the gravel edge past the Four Corners Golds — zape streaks catch the same late light the warm gold finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the purple-brown mottling and dew still holds. Mara ties ripe stems before the stand opens — the Rio Zape bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Rio Zape weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and stew sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Rio Zape when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const hopiBlackBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Rio Zape bean field",
    detail:
      "A jet-black belt of Hopi Black beans on the gravel edge past the Rio Zapes — glossy night seed catches the same late light the purple-brown mottling finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the jet-black seed and dew still holds. Mara ties ripe stems before the stand opens — the Hopi Black bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Hopi Black weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and stew sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Hopi Black when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const arikaraYellowBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Hopi Black bean field",
    detail:
      "A butter-yellow belt of Arikara Yellow beans on the gravel edge past the Hopi Blacks — warm prairie seed catches the same late light the jet-black finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the butter-yellow seed and dew still holds. Mara ties ripe stems before the stand opens — the Arikara Yellow bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Arikara Yellow weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and stew sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Arikara Yellow when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const trueRedCranberryBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Arikara Yellow bean field",
    detail:
      "A wine-red mottled belt of True Red Cranberry beans on the gravel edge past the Arikara Yellows — plump cranberry seed catches the same late light the butter-yellow finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the wine-red mottled seed and dew still holds. Mara ties ripe stems before the stand opens — the True Red Cranberry bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "True Red Cranberry weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and stew sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole True Red Cranberry when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const florDeMayoBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the True Red Cranberry bean field",
    detail:
      "A rose-lavender belt of Flor de Mayo beans on the gravel edge past the True Red Cranberries — soft May-flower seed catches the same late light the wine-red mottling finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the rose-lavender seed and dew still holds. Mara ties ripe stems before the stand opens — the Flor de Mayo bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Flor de Mayo weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and stew sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Flor de Mayo when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const bolitaBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Flor de Mayo bean field",
    detail:
      "A soft-tan belt of Bolita beans on the gravel edge past the Flor de Mayos — round New Mexico seed catches the same late light the rose-lavender finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the soft-tan seed and dew still holds. Mara ties ripe stems before the stand opens — the Bolita bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Bolita weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and stew sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Bolita when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const orcaBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Bolita bean field",
    detail:
      "An ink-and-ivory belt of Orca beans on the gravel edge past the Bolitas — yin-yang seed catches the same late light the soft-tan finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the ink-and-ivory orca seed and dew still holds. Mara ties ripe stems before the stand opens — the Orca bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Orca weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and stew sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Orca when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const hutteriteSoupBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Orca bean field",
    detail:
      "A golden-yellow belt of Hutterite Soup beans on the gravel edge past the Orcas — amber soup seed catches the same late light the ink-and-ivory finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the golden-yellow soup seed and dew still holds. Mara ties ripe stems before the stand opens — the Hutterite Soup bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Hutterite Soup weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and soup sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Hutterite Soup when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const kenearlyYellowEyeBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Hutterite Soup bean field",
    detail:
      "A cream-and-amber belt of Kenearly Yellow Eye beans on the gravel edge past the Hutterite Soups — pale seed with a warm yellow eye catches the same late light the golden-yellow soup finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the cream seed with its yellow eye and dew still holds. Mara ties ripe stems before the stand opens — the Kenearly Yellow Eye bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Kenearly Yellow Eye weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and baking sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Kenearly Yellow Eye when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const snowCapBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Kenearly Yellow Eye bean field",
    detail:
      "A snow-white belt of Snow Cap beans on the gravel edge past the Kenearly Yellow Eyes — ivory seed with a mahogany cap catches the same late light the cream-and-amber eye finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the ivory seed with its mahogany cap and dew still holds. Mara ties ripe stems before the stand opens — the Snow Cap bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Snow Cap weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and stew sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Snow Cap when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const swedishBrownBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Snow Cap bean field",
    detail:
      "A warm-brown belt of Swedish Brown beans on the gravel edge past the Snow Caps — cocoa-tan seed catches the same late light the ivory-and-mahogany cap finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the cocoa-tan seed and dew still holds. Mara ties ripe stems before the stand opens — the Swedish Brown bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Swedish Brown weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and baking sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Swedish Brown when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const peregionBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Swedish Brown bean field",
    detail:
      "A purple-mottled belt of Peregion beans on the gravel edge past the Swedish Browns — cream seed with wine-purple mottling catches the same late light the cocoa-tan finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the cream seed with wine-purple mottling and dew still holds. Mara ties ripe stems before the stand opens — the Peregion bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Peregion weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and stew sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Peregion when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;
...
const birdEggBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Yellow Indian Woman bean field",
    detail:
      "A cream-and-speckle belt of Bird Egg beans on the gravel edge past the Yellow Indian Women — brown-flecked seed catches the same late light the deep golden finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the cream seed with brown bird-egg flecks and dew still holds. Mara ties ripe stems before the stand opens — the Bird Egg bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Bird Egg weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and soup sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Bird Egg when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const mayflowerBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Bird Egg bean field",
    detail:
      "A cream-and-purple belt of Mayflower beans on the gravel edge past the Bird Eggs — lavender-mottled seed catches the same late light the cream bird-egg flecks finish on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the cream seed with purple Mayflower mottling and dew still holds. Mara ties ripe stems before the stand opens — the Mayflower bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Mayflower weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and baking sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Mayflower when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const turkeyCrawBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Mayflower bean field",
    detail:
      "A cream-and-brown belt of Turkey Craw beans on the gravel edge past the Mayflowers — turkey-craw mottled seed catches the same late light the cream-and-purple mottling finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the cream seed with brown turkey-craw mottling and dew still holds. Mara ties ripe stems before the stand opens — the Turkey Craw bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Turkey Craw weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and soup sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Turkey Craw when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;
...
const marfaxBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Steuben Yellow Eye bean field",
    detail:
      "A golden-amber belt of Marfax beans on the gravel edge past the Steuben Yellow Eyes — plump gold seed catches the same late light the cream-and-amber yellow eye finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the golden Marfax seed and dew still holds. Mara ties ripe stems before the stand opens — the Marfax bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "Marfax weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and baking sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole Marfax when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;

const kingOfTheEarlyBeanFieldWork = [
  {
    name: "Pod rows",
    rhythm: "After the Marfax bean field",
    detail:
      "A cream-ivory belt of King of the Early beans on the gravel edge past the Marfax — early baking seed catches the same late light the golden-amber Marfax finishes on, and the nodules knit the clay with nitrogen without crowding the orchard windbreak into damp.",
  },
  {
    name: "Pull mornings",
    rhythm: "Quiet dawn sheaves",
    detail:
      "Hand pull when the pods show the cream-ivory King of the Early seed and dew still holds. Mara ties ripe stems before the stand opens — the King of the Early bean field is a finish lane, not a combine parade that packs the clay into a path the CSA kids would track indoors.",
  },
  {
    name: "King of the Early weeks",
    rhythm: "Late autumn board",
    detail:
      "A few dry jars and baking sacks for the farm table after the pack shed has done its quiet work — Leah chalks whole King of the Early when the mill is honest. No anonymous commodity bin; just what the pod finished on Northfield clay.",
  },
] as const;
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[var(--soil)] text-[var(--foreground)]">
      <header className="absolute inset-x-0 top-0 z-20">
        <div className="relative mx-auto flex max-w-6xl items-center justify-between px-6 py-5 md:px-8">
          ...
          <nav className="hidden items-center gap-8 text-sm text-[var(--muted)] md:flex">
            ...
            <a href="#scarlet-runner-bean-field" className="transition hover:text-[var(--foreground)]">
              Scarlet Runner bean field
            </a>
            <a href="#rattlesnake-bean-field" className="transition hover:text-[var(--foreground)]">
              Rattlesnake bean field
            </a>
            <a href="#painted-pony-bean-field" className="transition hover:text-[var(--foreground)]">
              Painted Pony bean field
            </a>
            <a href="#soldier-bean-field" className="transition hover:text-[var(--foreground)]">
              Soldier bean field
            </a>
            ...
            <a href="#four-corners-gold-bean-field" className="transition hover:text-[var(--foreground)]">
              Four Corners Gold bean field
            </a>
            <a href="#rio-zape-bean-field" className="transition hover:text-[var(--foreground)]">
              Rio Zape bean field
            </a>
            <a href="#hopi-black-bean-field" className="transition hover:text-[var(--foreground)]">
              Hopi Black bean field
            </a>
            <a href="#arikara-yellow-bean-field" className="transition hover:text-[var(--foreground)]">
              Arikara Yellow bean field
            </a>
            <a href="#true-red-cranberry-bean-field" className="transition hover:text-[var(--foreground)]">
              True Red Cranberry bean field
            </a>
            <a href="#flor-de-mayo-bean-field" className="transition hover:text-[var(--foreground)]">
              Flor de Mayo bean field
            </a>
            <a href="#bolita-bean-field" className="transition hover:text-[var(--foreground)]">
              Bolita bean field
            </a>
            <a href="#orca-bean-field" className="transition hover:text-[var(--foreground)]">
              Orca bean field
            </a>
            <a href="#hutterite-soup-bean-field" className="transition hover:text-[var(--foreground)]">
              Hutterite Soup bean field
            </a>
            <a href="#kenearly-yellow-eye-bean-field" className="transition hover:text-[var(--foreground)]">
              Kenearly Yellow Eye bean field
            </a>
            <a href="#snow-cap-bean-field" className="transition hover:text-[var(--foreground)]">
              Snow Cap bean field
            </a>
            <a href="#swedish-brown-bean-field" className="transition hover:text-[var(--foreground)]">
              Swedish Brown bean field
            </a>
            ...
            <a href="#bird-egg-bean-field" className="transition hover:text-[var(--foreground)]">
              Bird Egg bean field
            </a>
            <a href="#mayflower-bean-field" className="transition hover:text-[var(--foreground)]">
              Mayflower bean field
            </a>
            ...
            <a href="#marfax-bean-field" className="transition hover:text-[var(--foreground)]">
              Marfax bean field
            </a>
            <a href="#king-of-the-early-bean-field" className="transition hover:text-[var(--foreground)]">
              King of the Early bean field
            </a>
      ...
      <main id="top">
        ...
        {/* Scarlet Runner bean field — one job: pod rows after the Dragon Tongue bean field, pull mornings + Scarlet Runner weeks */}
        <section
          id="scarlet-runner-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -left-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and scarlet bloom
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Scarlet Runner bean field that finishes the Dragon Tongue bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Scarlet Runner weeks — a warm-season belt of
              climbing scarlet after the Dragon Tongue bean field, then fresh snap baskets and dry jars
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {scarletRunnerBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Scarlet%20Runner%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Scarlet Runner bean field
            </a>
          </div>
        </section>

        {/* Rattlesnake bean field — one job: pod rows after the Scarlet Runner bean field, pull mornings + Rattlesnake weeks */}
        <section
          id="rattlesnake-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -left-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and purple mottling
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Rattlesnake bean field that finishes the Scarlet Runner bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Rattlesnake weeks — a warm-season belt of
              purple-streaked poles after the Scarlet Runner bean field, then fresh snap baskets and dry jars
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {rattlesnakeBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Rattlesnake%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Rattlesnake bean field
            </a>
          </div>
        </section>

        {/* Painted Pony bean field — one job: pod rows after the Rattlesnake bean field, pull mornings + Painted Pony weeks */}
        <section
          id="painted-pony-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -left-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and cream-maroon spots
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Painted Pony bean field that finishes the Rattlesnake bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Painted Pony weeks — a warm-season belt of
              cream-and-maroon piebald after the Rattlesnake bean field, then dry jars and chili sacks
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {paintedPonyBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Painted%20Pony%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Painted Pony bean field
            </a>
          </div>
        </section>

        {/* Soldier bean field — one job: pod rows after the Painted Pony bean field, pull mornings + Soldier weeks */}
        <section
          id="soldier-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -left-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and scarlet soldier blotch
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Soldier bean field that finishes the Painted Pony bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Soldier weeks — a warm-season belt of
              white-and-scarlet soldier-blotch after the Painted Pony bean field, then dry jars and baked-bean sacks
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {soldierBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Soldier%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Soldier bean field
            </a>
          </div>
        </section>

        {/* Tongue of Fire bean field — one job: pod rows after the Soldier bean field, pull mornings + Tongue of Fire weeks */}
        <section
          id="tongue-of-fire-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#101c14]"
        >
          <div className="pointer-events-none absolute -right-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and crimson fire streaks
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Tongue of Fire bean field that finishes the Soldier bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Tongue of Fire weeks — a warm-season belt of
              crimson-streaked cream after the Soldier bean field, then dry jars and stew sacks
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {tongueOfFireBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Tongue%20of%20Fire%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
        ...
        {/* Hidatsa Shield Figure bean field — one job: pod rows after the Good Mother Stallard bean field, pull mornings + Hidatsa Shield Figure weeks */}
        <section
          id="hidatsa-shield-figure-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -left-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and cream shield figure
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Hidatsa Shield Figure bean field that finishes the Good Mother Stallard bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Hidatsa Shield Figure weeks — a warm-season belt of
              cream-and-maroon shields after the Good Mother Stallard bean field, then dry jars and stew sacks
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {hidatsaShieldFigureBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Hidatsa%20Shield%20Figure%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
        ...
        {/* Four Corners Gold bean field — one job: pod rows after the Cherokee Trail of Tears bean field, pull mornings + Four Corners Gold weeks */}
        <section
          id="four-corners-gold-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -left-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and warm gold seed
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Four Corners Gold bean field that finishes the Cherokee Trail of Tears bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Four Corners Gold weeks — a warm-season belt of
              warm gold seed after the Cherokee Trail of Tears bean field, then dry jars and stew sacks
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {fourCornersGoldBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Four%20Corners%20Gold%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Four Corners Gold bean field
            </a>
          </div>
        </section>

        {/* Rio Zape bean field — one job: pod rows after the Four Corners Gold bean field, pull mornings + Rio Zape weeks */}
        <section
          id="rio-zape-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -left-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and purple-brown mottling
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Rio Zape bean field that finishes the Four Corners Gold bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Rio Zape weeks — a warm-season belt of
              purple-brown mottling after the Four Corners Gold bean field, then dry jars and stew sacks
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {rioZapeBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Rio%20Zape%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Rio Zape bean field
            </a>
          </div>
        </section>

        {/* Hopi Black bean field — one job: pod rows after the Rio Zape bean field, pull mornings + Hopi Black weeks */}
        <section
          id="hopi-black-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -left-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and jet-black seed
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Hopi Black bean field that finishes the Rio Zape bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Hopi Black weeks — a warm-season belt of
              jet-black seed after the Rio Zape bean field, then dry jars and stew sacks
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {hopiBlackBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Hopi%20Black%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Hopi Black bean field
            </a>
          </div>
        </section>

        {/* Arikara Yellow bean field — one job: pod rows after the Hopi Black bean field, pull mornings + Arikara Yellow weeks */}
        <section
          id="arikara-yellow-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -left-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and butter-yellow seed
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              An Arikara Yellow bean field that finishes the Hopi Black bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Arikara Yellow weeks — a warm-season belt of
              butter-yellow seed after the Hopi Black bean field, then dry jars and stew sacks
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {arikaraYellowBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Arikara%20Yellow%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Arikara Yellow bean field
            </a>
          </div>
        </section>

        {/* True Red Cranberry bean field — one job: pod rows after the Arikara Yellow bean field, pull mornings + True Red Cranberry weeks */}
        <section
          id="true-red-cranberry-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -left-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and wine-red mottled seed
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A True Red Cranberry bean field that finishes the Arikara Yellow bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and True Red Cranberry weeks — a warm-season belt of
              wine-red mottled seed after the Arikara Yellow bean field, then dry jars and stew sacks
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {trueRedCranberryBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20True%20Red%20Cranberry%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the True Red Cranberry bean field
            </a>
          </div>
        </section>

        {/* Flor de Mayo bean field — one job: pod rows after the True Red Cranberry bean field, pull mornings + Flor de Mayo weeks */}
        <section
          id="flor-de-mayo-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -left-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and rose-lavender seed
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Flor de Mayo bean field that finishes the True Red Cranberry bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Flor de Mayo weeks — a warm-season belt of
              rose-lavender seed after the True Red Cranberry bean field, then dry jars and stew sacks
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {florDeMayoBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Flor%20de%20Mayo%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Flor de Mayo bean field
            </a>
          </div>
        </section>

        {/* Bolita bean field — one job: pod rows after the Flor de Mayo bean field, pull mornings + Bolita weeks */}
        <section
          id="bolita-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -left-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and soft-tan seed
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Bolita bean field that finishes the Flor de Mayo bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Bolita weeks — a warm-season belt of
              soft-tan seed after the Flor de Mayo bean field, then dry jars and stew sacks
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {bolitaBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Bolita%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Bolita bean field
            </a>
          </div>
        </section>

        {/* Orca bean field — one job: pod rows after the Bolita bean field, pull mornings + Orca weeks */}
        <section
          id="orca-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          ...
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and ink-and-ivory orca seed
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              An Orca bean field that finishes the Bolita bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Orca weeks — a warm-season belt of
              ink-and-ivory orca seed after the Bolita bean field, then dry jars and stew sacks
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {orcaBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Orca%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Orca bean field
            </a>
          </div>
        </section>

        {/* Hutterite Soup bean field — one job: pod rows after the Orca bean field, pull mornings + Hutterite Soup weeks */}
        <section
          id="hutterite-soup-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -left-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and golden-yellow soup seed
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Hutterite Soup bean field that finishes the Orca bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Hutterite Soup weeks — a warm-season belt of
              golden-yellow soup seed after the Orca bean field, then dry jars and soup sacks
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {hutteriteSoupBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Hutterite%20Soup%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Hutterite Soup bean field
            </a>
          </div>
        </section>

        {/* Kenearly Yellow Eye bean field — one job: pod rows after the Hutterite Soup bean field, pull mornings + Kenearly Yellow Eye weeks */}
        <section
          id="kenearly-yellow-eye-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -left-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and cream-and-amber eye seed
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Kenearly Yellow Eye bean field that finishes the Hutterite Soup bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Kenearly Yellow Eye weeks — a warm-season belt of
              cream seed with a yellow eye after the Hutterite Soup bean field, then dry jars and baking sacks
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {kenearlyYellowEyeBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Kenearly%20Yellow%20Eye%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Kenearly Yellow Eye bean field
            </a>
          </div>
        </section>

        {/* Snow Cap bean field — one job: pod rows after the Kenearly Yellow Eye bean field, pull mornings + Snow Cap weeks */}
        <section
          id="snow-cap-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -left-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and ivory-and-mahogany cap seed
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Snow Cap bean field that finishes the Kenearly Yellow Eye bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Snow Cap weeks — a warm-season belt of
              ivory seed with a mahogany cap after the Kenearly Yellow Eye bean field, then dry jars and stew sacks
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {snowCapBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Snow%20Cap%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Snow Cap bean field
            </a>
          </div>
        </section>

        {/* Swedish Brown bean field — one job: pod rows after the Snow Cap bean field, pull mornings + Swedish Brown weeks */}
        <section
          id="swedish-brown-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -left-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and cocoa-tan seed
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Swedish Brown bean field that finishes the Snow Cap bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Swedish Brown weeks — a warm-season belt of
              cocoa-tan seed after the Snow Cap bean field, then dry jars and baking sacks
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {swedishBrownBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Swedish%20Brown%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Swedish Brown bean field
            </a>
          </div>
        </section>

        {/* Peregion bean field — one job: pod rows after the Swedish Brown bean field, pull mornings + Peregion weeks */}
        <section
          id="peregion-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -left-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and cream-and-wine mottled seed
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Peregion bean field that finishes the Swedish Brown bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Peregion weeks — a warm-season belt of
              cream seed with wine-purple mottling after the Swedish Brown bean field, then dry jars and stew sacks
              that find the farm table once the pack-shed lane has done
              its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {peregionBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Peregion%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
        ...
        {/* Bird Egg bean field — one job: pod rows after the Yellow Indian Woman bean field, pull mornings + Bird Egg weeks */}
        <section
          id="bird-egg-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -right-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and cream bird-egg flecked seed
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Bird Egg bean field that finishes the Yellow Indian Woman bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Bird Egg weeks — a warm-season belt of
              cream seed with brown bird-egg flecks after the Yellow Indian Woman bean field,
              then dry jars and soup sacks that find the farm table once the pack-shed lane
              has done its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {birdEggBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Bird%20Egg%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Bird Egg bean field
            </a>
          </div>
        </section>

        {/* Mayflower bean field — one job: pod rows after the Bird Egg bean field, pull mornings + Mayflower weeks */}
        <section
          id="mayflower-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -right-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and cream-and-purple mottled seed
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Mayflower bean field that finishes the Bird Egg bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Mayflower weeks — a warm-season belt of
              cream seed with purple Mayflower mottling after the Bird Egg bean field,
              then dry jars and baking sacks that find the farm table once the pack-shed lane
              has done its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {mayflowerBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Mayflower%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Mayflower bean field
            </a>
          </div>
        </section>

        {/* Turkey Craw bean field — one job: pod rows after the Mayflower bean field, pull mornings + Turkey Craw weeks */}
        <section
          id="turkey-craw-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -right-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and cream-and-brown turkey-craw mottled seed
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Turkey Craw bean field that finishes the Mayflower bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Turkey Craw weeks — a warm-season belt of
              cream seed with brown turkey-craw mottling after the Mayflower bean field,
              then dry jars and soup sacks that find the farm table once the pack-shed lane
              has done its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {turkeyCrawBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Turkey%20Craw%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
        ...
        {/* Marfax bean field — one job: pod rows after the Steuben Yellow Eye bean field, pull mornings + Marfax weeks */}
        <section
          id="marfax-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -right-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and golden-amber Marfax seed
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A Marfax bean field that finishes the Steuben Yellow Eye bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and Marfax weeks — a warm-season belt of
              plump gold seed after the Steuben Yellow Eye bean field,
              then dry jars and baking sacks that find the farm table once the pack-shed lane
              has done its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {marfaxBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20Marfax%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the Marfax bean field
            </a>
          </div>
        </section>

        {/* King of the Early bean field — one job: pod rows after the Marfax bean field, pull mornings + King of the Early weeks */}
        <section
          id="king-of-the-early-bean-field"
          className="relative overflow-hidden border-t border-[var(--line)] bg-[#0f1f16]"
        >
          <div className="pointer-events-none absolute -right-16 top-10 h-72 w-72 rounded-full bg-[var(--accent)]/10 blur-3xl" />
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[var(--accent)]">
              Pod and cream-ivory King of the Early seed
            </p>
            <h2 className="mt-3 max-w-2xl font-[family-name:var(--font-fraunces)] text-3xl font-semibold md:text-5xl">
              A King of the Early bean field that finishes the Marfax bean belt.
            </h2>
            <p className="mt-4 max-w-2xl text-[var(--muted)] md:text-lg">
              Pod rows, pull mornings, and King of the Early weeks — a warm-season belt of
              cream-ivory baking seed after the Marfax bean field,
              then dry jars and baking sacks that find the farm table once the pack-shed lane
              has done its quiet late-autumn work.
            </p>
            <ul className="mt-14 grid gap-10 md:grid-cols-3 md:gap-12">
              {kingOfTheEarlyBeanFieldWork.map((item, i) => (
                <li
                  key={item.name}
                  className="border-t border-[var(--line)] pt-6"
                >
            ...
            <a
              href="mailto:hello@northfield.farm?subject=Northfield%20King%20of%20the%20Early%20bean%20field"
              className="mt-12 inline-block rounded-sm border border-[var(--line)] px-6 py-3 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
              Ask about the King of the Early bean field
            </a>
          </div>
        </section>
