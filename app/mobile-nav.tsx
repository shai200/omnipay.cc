...
const links = [
  ...
  { href: "#cranberry-bean-field", label: "Cranberry bean field" },
  { href: "#anasazi-bean-field", label: "Anasazi bean field" },
  { href: "#mayocoba-bean-field", label: "Mayocoba bean field" },
  { href: "#flageolet-bean-field", label: "Flageolet bean field" },
  { href: "#calypso-bean-field", label: "Calypso bean field" },
  { href: "#tigers-eye-bean-field", label: "Tiger's Eye bean field" },
  { href: "#jacobs-cattle-bean-field", label: "Jacob's Cattle bean field" },
  { href: "#appaloosa-bean-field", label: "Appaloosa bean field" },
  { href: "#eye-of-the-goat-bean-field", label: "Eye of the Goat bean field" },
  { href: "#christmas-lima-bean-field", label: "Christmas Lima bean field" },
  { href: "#dragon-tongue-bean-field", label: "Dragon Tongue bean field" },
  { href: "#scarlet-runner-bean-field", label: "Scarlet Runner bean field" },
  { href: "#rattlesnake-bean-field", label: "Rattlesnake bean field" },
  { href: "#painted-pony-bean-field", label: "Painted Pony bean field" },
  { href: "#soldier-bean-field", label: "Soldier bean field" },
  ...
  { href: "#four-corners-gold-bean-field", label: "Four Corners Gold bean field" },
  { href: "#rio-zape-bean-field", label: "Rio Zape bean field" },
  { href: "#hopi-black-bean-field", label: "Hopi Black bean field" },
  { href: "#arikara-yellow-bean-field", label: "Arikara Yellow bean field" },
  { href: "#true-red-cranberry-bean-field", label: "True Red Cranberry bean field" },
  { href: "#flor-de-mayo-bean-field", label: "Flor de Mayo bean field" },
  { href: "#bolita-bean-field", label: "Bolita bean field" },
  { href: "#orca-bean-field", label: "Orca bean field" },
  { href: "#hutterite-soup-bean-field", label: "Hutterite Soup bean field" },
  { href: "#kenearly-yellow-eye-bean-field", label: "Kenearly Yellow Eye bean field" },
  { href: "#snow-cap-bean-field", label: "Snow Cap bean field" },
  { href: "#swedish-brown-bean-field", label: "Swedish Brown bean field" },
  ...
  { href: "#steuben-yellow-eye-bean-field", label: "Steuben Yellow Eye bean field" },
  { href: "#marfax-bean-field", label: "Marfax bean field" },
  { href: "#king-of-the-early-bean-field", label: "King of the Early bean field" },
